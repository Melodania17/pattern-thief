...
export default function PatternOfTheDay({ onExplore }) {
  ...
  return (
    <div style={{ background: "linear-gradient(145deg,#16161c,#1c1c24)", border: "1px solid rgba(212,168,67,0.3)", borderRadius: "14px", padding: "18px", position: "relative" }}>
      <button onClick={() => setDismissed(true)} aria-label="Dismiss" style={{ position: "absolute", top: "12px", right: "12px", width: "24px", height: "24px", borderRadius: "6px", background: "rgba(255,255,255,0.06)", border: "1px solid rgba(255,255,255,0.1)", color: "rgba(255,255,255,0.5)", fontSize: "13px", lineHeight: 1, cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", padding: 0 }}>✕</button>
