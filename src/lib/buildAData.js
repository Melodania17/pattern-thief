...
export const RADIUS_PROMPT_GUIDANCE = {
  near: "THEFT RADIUS = NEAR. Stay CLOSE to the user's own world: draw from their own industry, adjacent industries, or closely related fields. For a business problem, that means other companies, other business functions, or neighboring sectors — NOT distant domains like nature or myth. The goal is a recognizable, directly-transferable move they could apply immediately. Still avoid generic, obvious best-practice advice: even close-to-home, the pattern should be a specific non-obvious steal, not boilerplate.",
